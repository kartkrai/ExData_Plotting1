...
png("plot1.png", width=480, height=480)                                                                                         # Setting PNG Plot dimensions
hist(data$Global_active_power, col="red", main="Global Active Power", xlab="Global Active Power (kilowatts)")                   # Plot the graph
